...
#include <libaquacore/TransactionBase.h>
...
//			<< "    exportbare [ <uuid> , ... ]  Export given keys." << endl
			...
			<< "    createwallet  Create an Aquachain master wallet." << endl
...
//			<< "    recode [ <address>|<uuid>|<file> , ... ]  Decrypt and re-encrypt given keys." << endl
			...
			<< "    --wallet-path <path>  Specify Aquachain wallet path (default: " << KeyManager::defaultPath() << ")" << endl
