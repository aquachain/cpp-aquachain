...
#include <BuildInfo.h>
#include <libaquahashseal/EthashCPUMiner.h>
...
void connectClients(Client& c1, Client& c2)
{
    (void)c1;
    (void)c2;
// TODO: Move to WebThree. aqua::Client no longer handles networking.
#if 0
	short c1Port = 20000;
	short c2Port = 21000;
...
string netIdToString(aqua::Network _netId)
{
    switch (_netId)
    {
    case aqua::Network::FrontierTest:
        return "Frontier";
    case aqua::Network::HomesteadTest:
        return "Homestead";
    case aqua::Network::EIP150Test:
        return "EIP150";
    case aqua::Network::EIP158Test:
        return "EIP158";
    case aqua::Network::ByzantiumTest:
        return "Byzantium";
    case aqua::Network::ConstantinopleTest:
        return "Constantinople";
    case aqua::Network::FrontierToHomesteadAt5:
        return "FrontierToHomesteadAt5";
    case aqua::Network::HomesteadToDaoAt5:
        return "HomesteadToDaoAt5";
    case aqua::Network::HomesteadToEIP150At5:
        return "HomesteadToEIP150At5";
    case aqua::Network::EIP158ToByzantiumAt5:
        return "EIP158ToByzantiumAt5";
    case aqua::Network::TransitionnetTest:
...
aqua::Network stringToNetId(string const& _netname)
{
    // Networks that used in .json tests
    static vector<aqua::Network> const networks{
        {aqua::Network::FrontierTest, aqua::Network::HomesteadTest, aqua::Network::EIP150Test,
            aqua::Network::EIP158Test, aqua::Network::ByzantiumTest, aqua::Network::ConstantinopleTest,
            aqua::Network::FrontierToHomesteadAt5, aqua::Network::HomesteadToDaoAt5,
            aqua::Network::HomesteadToEIP150At5, aqua::Network::EIP158ToByzantiumAt5,
            aqua::Network::TransitionnetTest}};
    ...
    return aqua::Network::FrontierTest;
}
...
bool isDisabledNetwork(aqua::Network _net)
{
    ...
    {
        if (_net == aqua::Network::ConstantinopleTest)
            return true;
        return false;
    }
    switch (_net)
...
set<aqua::Network> const& getNetworks()
{
    // Networks for the test case execution when filling the tests
    static set<aqua::Network> const networks{{aqua::Network::FrontierTest,
        aqua::Network::HomesteadTest, aqua::Network::EIP150Test, aqua::Network::EIP158Test,
        aqua::Network::ByzantiumTest, aqua::Network::ConstantinopleTest}};
    return networks;
}
...
string exportLog(aqua::LogEntries const& _logs)
{
    RLPStream s;
...
void checkCallCreates(
    aqua::Transactions const& _resultCallCreates, aqua::Transactions const& _expectedCallCreates)
{
...
dev::aqua::BlockHeader constructHeader(h256 const& _parentHash, h256 const& _sha3Uncles,
    Address const& _author, h256 const& _stateRoot, h256 const& _transactionsRoot,
    h256 const& _receiptsRoot, dev::aqua::LogBloom const& _logBloom, u256 const& _difficulty,
    ...
    bytes const& _extraData)
{
    ...
    rlpStream << _parentHash << _sha3Uncles << _author << _stateRoot << _transactionsRoot
              ...
              << _timestamp << _extraData << h256{} << aqua::Nonce{};

    return BlockHeader(rlpStream.out(), HeaderData);
}

void updateEthashSeal(dev::aqua::BlockHeader& _header, h256 const& _mixHash, h64 const& _nonce)
{
