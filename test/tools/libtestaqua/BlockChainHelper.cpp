...
#include <libaquachain/TransactionQueue.h>
...
void TestBlock::mine(TestBlockChain const& _bc)
{
    ...
    try
    {
        ...
        // mining!");
        dev::aqua::mine(block, blockchain, blockchain.sealEngine());
...
void TestBlock::updateNonce(TestBlockChain const& _bc)
{
    ...
    else
    {
        ...
        dev::aqua::mine(m_blockHeader, _bc.getInterface().sealEngine(), false);
    }
