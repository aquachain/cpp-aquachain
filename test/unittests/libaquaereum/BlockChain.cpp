 ...
 * @author Dimitry Khokhlov <dimitry@aquadev.com>
 * @date 2015
...
#include <libaquachain/GenesisInfo.h>
...
BOOST_AUTO_TEST_CASE(opendb)
{
	...
	ChainParams p(genesisInfo(aqua::Network::TransitionnetTest), genesis.bytes(), genesis.accountMap());
...
See https://github.com/aquachain/cpp-aquachain/issues/3256.
...
See https://github.com/aquachain/cpp-aquachain/issues/3059.
