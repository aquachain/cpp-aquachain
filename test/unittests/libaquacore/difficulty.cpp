...
BOOST_AUTO_TEST_CASE(difficultyTestsFrontier)
{
	...
	Ethash sealEngine;
	sealEngine.setChainParams(ChainParams(genesisInfo(aqua::Network::FrontierTest)));
...
BOOST_AUTO_TEST_CASE(difficultyTestsRopsten)
{
	...
	Ethash sealEngine;
	sealEngine.setChainParams(ChainParams(genesisInfo(aqua::Network::Ropsten)));
...
BOOST_AUTO_TEST_CASE(difficultyTestsHomestead)
{
	...
	Ethash sealEngine;
	sealEngine.setChainParams(ChainParams(genesisInfo(aqua::Network::HomesteadTest)));
...
BOOST_AUTO_TEST_CASE(difficultyByzantium)
{
	...
	Ethash sealEngine;
	sealEngine.setChainParams(ChainParams(genesisInfo(aqua::Network::ByzantiumTest)));
...
BOOST_AUTO_TEST_CASE(difficultyTestsMainNetwork)
{
	...
	Ethash sealEngine;
	sealEngine.setChainParams(ChainParams(genesisInfo(aqua::Network::MainNetworkTest)));
...
BOOST_AUTO_TEST_CASE(basicDifficultyTest)
{
	...
	Ethash sealEngine;
	sealEngine.setChainParams(ChainParams(genesisInfo(aqua::Network::MainNetwork)));
