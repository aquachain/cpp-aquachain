...
# such a standard, we have chosen to make a "fake packaging system" for cpp-aquachain, which is
# implemented in https://github.com/aquachain/cpp-dependencies.
#
...
# https://github.com/aquachain/webthree-umbrella/issues/509
#
...
# approach which Pawel has taken for LLVM in https://github.com/aquachain/evmjit.

if (MSVC)
	if (CMAKE_CXX_COMPILER_VERSION VERSION_LESS 19.0.0)
		message(FATAL_ERROR "ERROR - As of the 1.3.0 release, cpp-aquachain only supports Visual Studio 2015 or newer.\nPlease download from https://www.visualstudio.com/en-us/products/visual-studio-community-vs.aspx.")
	else()
