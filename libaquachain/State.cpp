...
void State::commit(CommitBehaviour _commitBehaviour)
{
    if (_commitBehaviour == CommitBehaviour::RemoveEmptyAccounts)
        removeEmptyAccounts();
    m_touched += dev::aqua::commit(m_cache, m_state);
    m_changeLog.clear();
    m_cache.clear();
...
std::ostream& dev::aqua::operator<<(std::ostream& _out, State const& _s)
{
...
State& dev::aqua::createIntermediateState(State& o_s, Block const& _block, unsigned _txIndex, BlockChain const& _bc)
{
    o_s = _block.state();
...
template <class DB>
AddressHash dev::aqua::commit(AccountMap const& _cache, SecureTrieDB<Address, DB>& _state)
{
    AddressHash ret;
...
template AddressHash dev::aqua::commit<OverlayDB>(AccountMap const& _cache, SecureTrieDB<Address, OverlayDB>& _state);
template AddressHash dev::aqua::commit<MemoryDB>(AccountMap const& _cache, SecureTrieDB<Address, MemoryDB>& _state);
