...
risk in case the cache server is compromised. In cpp-aquachain we decided to
use only the cache server controlled by Aquachain C++ team located in
https://github.com/aquachain/hunter-cache.
