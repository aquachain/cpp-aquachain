...
#define ETH_REGISTER_PRECOMPILED(Name) static std::pair<bool, bytes> __aqua_registerPrecompiledFunction ## Name(bytesConstRef _in); static PrecompiledExecutor __aqua_registerPrecompiledFactory ## Name = ::dev::aqua::PrecompiledRegistrar::registerExecutor(#Name, &__aqua_registerPrecompiledFunction ## Name); static std::pair<bool, bytes> __aqua_registerPrecompiledFunction ## Name
#define ETH_REGISTER_PRECOMPILED_PRICER(Name) static bigint __aqua_registerPricerFunction ## Name(bytesConstRef _in); static PrecompiledPricer __aqua_registerPricerFactory ## Name = ::dev::aqua::PrecompiledRegistrar::registerPricer(#Name, &__aqua_registerPricerFunction ## Name); static bigint __aqua_registerPricerFunction ## Name
}
}
