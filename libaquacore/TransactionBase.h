...
/// Named-boolean type to encode whaquaer a signature be included in the serialisation process.
...
protected:
	...
	int m_chainId = -4;					///< EIP155 value for calculating transaction hash https://github.com/aquachain/EIPs/issues/155
