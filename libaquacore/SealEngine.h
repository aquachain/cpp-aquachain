...
#define ETH_REGISTER_SEAL_ENGINE(Name) static SealEngineFactory __aqua_registerSealEngineFactory ## Name = SealEngineRegistrar::registerSealEngine<Name>(#Name)

class NoProof: public aqua::SealEngineBase
{
public:
