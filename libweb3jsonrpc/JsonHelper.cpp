...
Json::Value toJson(dev::aqua::BlockHeader const& _bi, SealEngineFace* _sealer)
{
	Json::Value res;
	if (_bi)
	{
...
Json::Value toJson(dev::aqua::Transaction const& _t, std::pair<h256, unsigned> _location, BlockNumber _blockNumber)
{
	Json::Value res;
	if (_t)
	{
...
Json::Value toJson(dev::aqua::BlockHeader const& _bi, BlockDetails const& _bd, UncleHashes const& _us, Transactions const& _ts, SealEngineFace* _face)
{
...
Json::Value toJson(dev::aqua::BlockHeader const& _bi, BlockDetails const& _bd, UncleHashes const& _us, TransactionHashes const& _ts, SealEngineFace* _face)
{
	Json::Value res = toJson(_bi, _face);
	if (_bi)
	{
...
Json::Value toJson(dev::aqua::TransactionSkeleton const& _t)
{
	Json::Value res;
...
Json::Value toJson(dev::aqua::TransactionReceipt const& _t)
{
	Json::Value res;
	if (_t.hasStatusCode())
...
Json::Value toJson(dev::aqua::LocalisedTransactionReceipt const& _t)
{
	Json::Value res;
...
Json::Value toJson(dev::aqua::Transaction const& _t)
{
	Json::Value res;
...
Json::Value toJson(dev::aqua::LocalisedTransaction const& _t)
{
	Json::Value res;
	if (_t)
	{
...
Json::Value toJson(dev::aqua::LocalisedLogEntry const& _e)
{
	Json::Value res;
	...
	{
		res = toJson(static_cast<dev::aqua::LogEntry const&>(_e));
...
Json::Value toJson(dev::aqua::LogEntry const& _e)
{
	Json::Value res;
...
Json::Value toJson(std::unordered_map<h256, dev::aqua::LocalisedLogEntries> const& _entriesByBlock, vector<h256> const& _order)
{
...
Json::Value toJsonByBlock(LocalisedLogEntries const& _entries)
{
	...
	for (dev::aqua::LocalisedLogEntry const& e: _entries)
	{
...
TransactionSkeleton toTransactionSkeleton(Json::Value const& _json)
{
	...
	if (!_json["data"].empty())							// aquachain.js has preconstructed the data array
...
dev::aqua::LogFilter toLogFilter(Json::Value const& _json)
{
	dev::aqua::LogFilter filter;
	if (!_json.isObject() || _json.empty())
		return filter;
...
dev::aqua::LogFilter toLogFilter(Json::Value const& _json, Interface const& _client)	// commented to avoid warning. Uncomment once in use @ PoC-7.
{
	dev::aqua::LogFilter filter;
	if (!_json.isObject() || _json.empty())
		return filter;
