    ...
    namespace rpc {
        class NetFace : public ServerInterface<NetFace>
        {
            public:
                NetFace()
                {
                    this->bindAndAddMaquaod(jsonrpc::Procedure("net_version", jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_STRING,  NULL), &dev::rpc::NetFace::net_versionI);
                    this->bindAndAddMaquaod(jsonrpc::Procedure("net_peerCount", jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_STRING,  NULL), &dev::rpc::NetFace::net_peerCountI);
                    this->bindAndAddMaquaod(jsonrpc::Procedure("net_listening", jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_BOOLEAN,  NULL), &dev::rpc::NetFace::net_listeningI);
                }
