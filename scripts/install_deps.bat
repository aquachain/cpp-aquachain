...
REM ---------------------------------------------------------------------------
REM Batch file for installing pre-requisite packages for cpp-aquachain on
...
REM
REM See https://github.com/aquachain/cpp-dependencies
REM
...
REM     https://github.com/aquachain/webthree-umbrella/issues/345
REM
REM     See "Windows - Try to use NuGet C++ packages"
REM     https://github.com/aquachain/webthree-umbrella/issues/509
REM
REM     See "CM - Can we switch to NuGet delivery for our external dependencies"
REM     https://github.com/aquachain/webthree-umbrella/issues/376
REM
