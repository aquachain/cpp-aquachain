...
#------------------------------------------------------------------------------
# Python script to analysis cpp-aquachain commits, and filter out duplicates
#
...
authorAliases['chrisaqua'] = 'Christian Reitwiessner'
